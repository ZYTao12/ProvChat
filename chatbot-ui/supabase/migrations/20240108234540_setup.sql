...
AS $$
DECLARE
  project_url TEXT := 'https://tojpffuugljlqqdbsyrz.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRvanBmZnV1Z2xqbHFxZGJzeXJ6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1Njk0NDE5NiwiZXhwIjoyMDcyNTIwMTk2fQ.v6PWz8_v095eLzU2h6NEbqHrfUUVBCq0bp_XBMnWtCk'; -- full access needed for http request to storage
