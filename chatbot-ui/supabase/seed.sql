...
('e9fc7e46-a8a5-4fd4-8ba7-af485013e6fa', 'Workspace 1', 'This is for testing.', 4000, 'gpt-5-2025-08-07', 'You are an assistant.', 1, true, true, 'These are the instructions.', false, 'private', 'openai');
